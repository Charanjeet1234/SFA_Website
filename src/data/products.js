export const seoProducts = [
    ...
    faqs: [
      {
        ...
        answer:
          "Ferro manganese is used in steelmaking to improve strength, toughness, and wear resistance while also assisting with deoxidation and desulfurization."
      },
      {
      ...
      },
      {
        ...
        answer:
          "We supply various grades, including HC, MC, and LC ferro manganese depending on the production requirements of the buyer."
      }
    ]
  },
  {
    ...
    applications: [
      ...
      "Desulfurization",
      "Improved toughness and performance"
    ],
    faqs: [
      {
        question: "What is silico manganese used for?",
        answer:
          "Silico manganese is used to improve the manganese and silicon content in steel, helping control strength, toughness, and deoxidation during production."
      },
      {
  ...
  },
  {
    ...
    faqs: [
      {
        question: "Why is ferro chrome important?",
        answer:
          "Ferro chrome increases the chromium content in steel and improves corrosion resistance, hardness, and durability."
      },
      {
  ...
  },
  {
    ...
    faqs: [
      {
        question: "What is ferro silicon used for?",
        answer:
          "Ferro silicon is used in deoxidation and alloying in steelmaking and foundry operations, helping improve the final product quality."
      },
      {
        question: "Why choose a ferro silicon supplier in UAE?",
        answer:
          "A reliable supplier ensures quality consistency, traceability, and timely logistics for steel and industrial production needs."
      }
    ]
  },
  {
    ...
    faqs: [
      {
        question: "What is manganese ore used for?",
        answer:
          "Manganese ore is used as a feedstock in the production of ferro manganese, silico manganese, and other essential metallurgical products."
      },
      {
  ...
  },
  {
    ...
    faqs: [
      {
        question: "Why is ferro molybdenum used in steel?",
        answer:
          "Ferro molybdenum improves strength, hardness, and resistance to corrosion and high-temperature degradation in specialized steel grades."
      },
      {
...
export const seoProductsMap = Object.fromEntries(
  seoProducts.map((product) => [product.slug, product])
);
