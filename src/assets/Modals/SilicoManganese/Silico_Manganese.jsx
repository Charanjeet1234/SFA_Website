...
function Silico_Manganese() {
  const productName = "Silico Manganese";
      ...
      <div className="modal-dialog modal-dialog-scrollable modal-lg">
        <div className="modal-content">
          ...
          <div className="modal-body">
            <p>
              Silico Manganese is an alloy with 60% to 70% manganese, 14% to 16%
              silicon, and 1.5% to 2% carbon. It is produced by smelting of slag
              from high-carbon Ferro Manganese or of Manganese ore with coke and
              a quartz flux. Smelting temperatures are high and greater energy
              is needed to reduce the quartz to silicon. So, the process
