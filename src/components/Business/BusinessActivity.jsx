  ...
  return (
    <div className="BusinessActivity" id="BusinessActivity">
      <div className="BusinessContent">
        ...
        <p>
          SFA Globex DMCC has divided its business activities in three major
          segments:
        </p>
        <ul>
          <li>Trading</li>
        ...
        <b>Trading</b>
        <p>
          Management of SFA Globex DMCC have very close connections with all
          major producers of ferro alloys in India, which help us to procure
          ferro alloys at very competitive price in India
          <br />
          <br />
          Now, SFA Globex DMCC is also looking to expand their product portfolio
        ...
        <b>Financing:</b>
        <p>
          SFA GLOBEX DMCC also financing raw materials i.e. manganese ore to our
        ...
        <b>Indenting:</b>
        <p>
          For some products, SFA GLOBEX DMCC chose to work as a indentor for a
